...
/*     */   float orientation;
/*     */   float o0;
/* 480 */   float speed = 0.4F;
/*     */   float money;
/*     */   
/*     */   public PirateShip(float paramFloat1, float paramFloat2, float paramFloat3) {
/* 484 */     this.x = paramFloat1;
/* 485 */     this.z = paramFloat2;
/* 486 */     this.o0 = paramFloat3;
/* 487 */     this.money = parampirate_game.random(200.0F, 500.0F);
/* 488 */     parampirate_game.currentShips++;
/*     */   }
/*     */   float cannonTimer;
/*     */   
...
/*     */       
/* 518 */       pirate_game.this.cannonballs.add(new pirate_game.Cannonball(pirate_game.this, this.x + pirate_game.cos(-this.orientation) * 3.0F, this.z + pirate_game.sin(-this.orientation) * 3.0F, pirate_game.cos(-this.orientation), pirate_game.sin(-this.orientation), true));
...
/* 541 */         pirate_game.this.explosions.add(new pirate_game.Explosion(pirate_game.this, this.x, this.z, false));
